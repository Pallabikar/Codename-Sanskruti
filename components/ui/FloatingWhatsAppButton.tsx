  ...
  return (
    <div className="fixed bottom-20 right-6 z-40">
      <a
        ...
        className="group relative flex items-center gap-2.5 bg-[#25D366] hover:bg-[#1EBE57] text-white px-4 py-3 sm:px-5 sm:py-3.5 rounded-full shadow-2xl hover:shadow-[#25D366]/40 transition-all duration-300 transform hover:-translate-y-1 active:translate-y-0 text-xs font-bold tracking-wider uppercase border border-white/20 cursor-pointer"
      ...
      >
        ...
        <span className="font-sans">WhatsApp Us</span>
      </a>
    </div>
  );
}
